  ...
  return (
    <div className="bg-gray-500/50 rounded-full p-1">
      <svg width="18" height="18" viewBox="0 0 32 32" aria-label={`${foiling} foil`}>
        ...
        <line x1="10" y1="2"  x2="16" y2="13" stroke={isCold ? 'rgba(56,189,248,0.8)'  : 'rgba(255,255,255,0.55)'}  strokeWidth="1.2" />
        <line x1="22" y1="2"  x2="16" y2="13" stroke={isCold ? 'rgba(56,189,248,0.8)'  : 'rgba(255,255,255,0.55)'}  strokeWidth="1.2" />
        <line x1="1"  y1="13" x2="31" y2="13" stroke={isCold ? 'rgba(56,189,248,0.65)' : 'rgba(255,255,255,0.45)'}  strokeWidth="1.2" />
        <line x1="16" y1="13" x2="16" y2="30" stroke={isCold ? 'rgba(56,189,248,0.55)' : 'rgba(255,255,255,0.35)'}  strokeWidth="1.2" />

        {/* sun-glint sweep — clips to diamond, pauses between passes */}
        <rect x="-14" y="0" width="14" height="32" fill={`url(#${isCold ? coldShineId : shineId})`} clipPath={`url(#${clipId})`}>
          <animate
            attributeName="x"
            values="-14;32;32"
            keyTimes="0;0.2;1"
